              ...
              <ul class=" navbar-right"> 
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item"  href="<?php echo e(route('akun.create')); ?>">Data Account</a>
                    <a class="dropdown-item"  href="<?php echo e(route('akun.index')); ?>">Register</a>
...
<?php /**PATH C:\xampp\htdocs\1_HIMED\BACKEND\resources\views/layout/main.blade.php ENDPATH**/ ?>