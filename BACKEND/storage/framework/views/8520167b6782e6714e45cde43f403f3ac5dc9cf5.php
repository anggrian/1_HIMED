...
<head>
    ...
    <!--load all styles -->
    <!-- Css sendiri -->
    <link rel="stylesheet" href="<?php echo e(asset('template-himed-final/css/style.css')); ?>">
    <!-- font google popins -->
...
<body>
    ...
    <section class="bub-right">
        <div class="container container-result">
            ...
            <div class="img-result">
                <img src="img/about-us.png" alt="" class="gambar-result">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="img/section-icon/section-icon-2.svg" alt="***">
                    ...
                    <div class="card shadow">
                        <div class="header-hiw">
                            <div class="service_icon">
                                <img src="img/icon h1-h3/h1.png" class="colored-icon" alt="">
        ...
        <div class="container">
            <div class="content">
                ...
                <div class="content-cof">
                    <div class="img-cof">
                        <img src="img/about/about1.svg" alt="" class="img-cof-about">
                    </div>
                    <div class="modal-cof">
                        <div class="card mb-3">
                            <div class="row g-0 sub-cof">
                                <div class="col-md-4">
                                    <img src="img/feature/feature1.svg" alt="..." class="img-cof-feature">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3">
                            <div class="row g-0 sub-cof">
                                <div class="col-md-4">
                                    <img src="img/feature/feature2.svg" alt="..." class="img-cof-feature">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Measure the customer experience</h5>
                        ...
                        <div class="card mb-3">
                            <div class="row g-0 sub-cof">
                                <div class="col-md-4">
                                    <img src="img/feature/feature3.svg" alt="..." class="img-cof-feature">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Measure the customer experience</h5>
    ...
    <section class="hex-pat-1">
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="img/section-icon/section-icon-3.svg" alt="***">
                ...
                <div class="card-our-services">
                    <div class="card shadow">
                        <div class="header"><img src="img/Our-Services/s1.png" alt="" class="img-our-services"></div>
                        <div class="content">
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="img/Our-Services/s2.png" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="img/Our-Services/s3.png" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                ...
                <div class="card-our-services">
                    <div class="card shadow">
                        <div class="header"><img src="img/Our-Services/s4.png" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="img/Our-Services/s5.png" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="img/Our-Services/s6.png" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
    ...
    <section class="faq-timeline-area">
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="img/section-icon/section-icon-5.svg" alt="img_section-icon-5.svg">
    ...
    <section style="background: #edf6fd;">
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="img/section-icon/section-icon-2.svg" alt="img_section-icon-5.svg">
                    ...
                    <div class="row">
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="header-img">
                                    <div class="testimonial-image">
                                        <img src="img/test-img/3.jpg" alt="" class="img-lovly">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="single-testimonial">
                                ...
                                <div class="header-img">
                                    <div class="testimonial-image">
                                        <img src="img/test-img/2.jpg" alt="" class="img-lovly">
                                    </div>
                                </div>
                                <!-- Testimonial Feedback Text  -->
                                <div class="testimonial-description">
...
</html><?php /**PATH C:\xampp\htdocs\1_HIMED\BACKEND\resources\views/web/page.blade.php ENDPATH**/ ?>