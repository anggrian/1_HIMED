    ...
    <section class="bub-right">
        <div class="container container-result">
            <div class="result">
                <h4><?php echo e($features->main_title); ?></h4>
                <p><?php echo e($features->main_description); ?></p>
                <button class="btn btn-primary">READ MORE</button>
            </div>
            <div class="img-result">
                <img src="assets/uploads/<?php echo e($features->thumbnail); ?>" alt="" class="gambar-result">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="<?php echo e(asset('style_frontend/img/section-icon/section-icon-2.svg')); ?>" alt="***">
                    ...
                    <div class="card shadow">
                        <div class="header-hiw">
                            <div class="service_icon">
                                <img src="<?php echo e(asset('style_frontend/img/icon h1-h3/h1.png')); ?>" class="colored-icon" alt="">
        ...
        <div class="container">
            <div class="content">
                ...
                <div class="content-cof">
                    <div class="img-cof">
                        <img src="<?php echo e(asset('style_frontend/img/about/about1.svg')); ?>" alt="" class="img-cof-about">
                    </div>
                    <div class="modal-cof">
                        <div class="card mb-3">
                            <div class="row g-0 sub-cof">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('style_frontend/img/feature/feature1.svg')); ?>" alt="..." class="img-cof-feature">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3">
                            <div class="row g-0 sub-cof">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('style_frontend/img/feature/feature2.svg')); ?>" alt="..." class="img-cof-feature">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Measure the customer experience</h5>
                        ...
                        <div class="card mb-3">
                            <div class="row g-0 sub-cof">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('style_frontend/img/feature/feature3.svg')); ?>" alt="..." class="img-cof-feature">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Measure the customer experience</h5>
    ...
    <section class="hex-pat-1">
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="<?php echo e(asset('style_frontend/img/section-icon/section-icon-3.svg')); ?>" alt="***">
                ...
                <div class="card-our-services">
                    <div class="card shadow">
                        <div class="header"><img src="<?php echo e(asset('style_frontend/img/Our-Services/s1.png')); ?>" alt="" class="img-our-services"></div>
                        <div class="content">
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="<?php echo e(asset('style_frontend/img/Our-Services/s2.png')); ?>" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="<?php echo e(asset('style_frontend/img/Our-Services/s3.png')); ?>" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                ...
                <div class="card-our-services">
                    <div class="card shadow">
                        <div class="header"><img src="<?php echo e(asset('style_frontend/img/Our-Services/s4.png')); ?>" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="<?php echo e(asset('style_frontend/img/Our-Services/s5.png')); ?>" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
                    ...
                    <div class="card shadow">
                        <div class="header"><img src="<?php echo e(asset('style_frontend/img/Our-Services/s6.png')); ?>" alt="" class="img-our-services"></div>
                        <div class="content">
                            <h6 class="bold">Enterprise Job Scheduling</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                        </div>
    ...
    <section class="faq-timeline-area">
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="<?php echo e(asset('style_frontend/img/section-icon/section-icon-5.svg')); ?>" alt="img_section-icon-5.svg">
                    <h2 class="bold font-header">Frequently Questions</h2>
                    <p class="text-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis accumsan nisi Ut ut felis congue nisl hendrerit commodo.</p>
                </div>
                <div class="content-frequntly">
                    <div class="image-frequntly">
                        <img src="<?php echo e(asset('style_frontend/img/about/about3.svg')); ?>" alt="img_about-3" class="frequntly">
                    </div>
    ...
    <section style="background: #edf6fd;">
        <div class="container">
            <div class="content">
                <div class="header-content">
                    <img src="<?php echo e(asset('style_frontend/img/section-icon/section-icon-2.svg')); ?>" alt="img_section-icon-5.svg">
                    ...
                    <div class="row">
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="header-img">
                                    <div class="testimonial-image">
                                        <img src="<?php echo e(asset('style_frontend/img/test-img/3.jpg')); ?>" alt="" class="img-lovly">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="single-testimonial">
                                ...
                                <div class="header-img">
                                    <div class="testimonial-image">
                                        <img src="<?php echo e(asset('style_frontend/img/test-img/2.jpg')); ?>" alt="" class="img-lovly">
                                    </div>
                                </div>
                                <!-- Testimonial Feedback Text  -->
                                <div class="testimonial-description">
            ...
            <div class="container-footer">
                <div class="kolom robovision pt-4">
                    <div class="footer-logo">
                        <a href="#"><img src="<?php echo e(asset('style_frontend/img/logo.png')); ?>" alt="logo" class="img-robovision"> <span class="text-robovision">RoboVision</span> </a>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\1_HIMED\HIMED\resources\views/Frontend/page.blade.php ENDPATH**/ ?>