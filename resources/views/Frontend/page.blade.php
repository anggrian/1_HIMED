...
<section class="section-home">
    <div class="container">
        <div class="home">
            ...
            <p>Lorem ipsum dolor sit amet, adipisicing elit. Quod corrupti laborum, quasi? Dolor sapiente amet optio
                harum dolores, voluptate, tempora dolorem fugiat fuga autem .</p>
            <div class="btn-home">
    ...
    <div class="container">
        <div class="content">
            <div class="header-content">
                ...
                <p class="text-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis accumsan nisi
                ...
                <div class="card shadow">
                    <div class="header-hiw">
                        <div class="service_icon">
                            <img src="{{ asset('style_frontend/img/icon h1-h3/h1.png') }}" class="colored-icon"
                                alt="">
                ...
                <div class="modal-cof">
                    <div class="card mb-3">
                        <div class="row g-0 sub-cof">
                            <div class="col-md-4">
                                <img src="{{ asset('style_frontend/img/feature/feature1.svg') }}" alt="..."
                                    class="img-cof-feature">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Measure the customer experience</h5>
                                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                        Laudantium modi assumenda beatae.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-3">
                        <div class="row g-0 sub-cof">
                            <div class="col-md-4">
                                <img src="{{ asset('style_frontend/img/feature/feature2.svg') }}" alt="..."
                                    class="img-cof-feature">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                    ...
                    <div class="card mb-3">
                        <div class="row g-0 sub-cof">
                            <div class="col-md-4">
                                <img src="{{ asset('style_frontend/img/feature/feature3.svg') }}" alt="..."
                                    class="img-cof-feature">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="card-our-services">
                <div class="card shadow">
                    <div class="header"><img src="{{ asset('style_frontend/img/Our-Services/s1.png') }}" alt=""
                            class="img-our-services"></div>
                    <div class="content">
                        <h6 class="bold">Enterprise Job Scheduling</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan
                            ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                    </div>
                </div>
                <div class="card shadow">
                    <div class="header"><img src="{{ asset('style_frontend/img/Our-Services/s2.png') }}" alt=""
                            class="img-our-services"></div>
                    <div class="content">
                        <h6 class="bold">Enterprise Job Scheduling</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan
                ...
                <div class="card shadow">
                    <div class="header"><img src="{{ asset('style_frontend/img/Our-Services/s3.png') }}" alt=""
                            class="img-our-services"></div>
                    <div class="content">
                        <h6 class="bold">Enterprise Job Scheduling</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan
            ...
            <div class="card-our-services">
                <div class="card shadow">
                    <div class="header"><img src="{{ asset('style_frontend/img/Our-Services/s4.png') }}" alt=""
                            class="img-our-services"></div>
                    <div class="content">
                        <h6 class="bold">Enterprise Job Scheduling</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan
                ...
                <div class="card shadow">
                    <div class="header"><img src="{{ asset('style_frontend/img/Our-Services/s5.png') }}" alt=""
                            class="img-our-services"></div>
                    <div class="content">
                        <h6 class="bold">Enterprise Job Scheduling</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan
                ...
                <div class="card shadow">
                    <div class="header"><img src="{{ asset('style_frontend/img/Our-Services/s6.png') }}" alt=""
                            class="img-our-services"></div>
                    <div class="content">
                        <h6 class="bold">Enterprise Job Scheduling</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan
...
<section class="faq-timeline-area">
    <div class="container">
        <div class="content">
            <div class="header-content">
                <img src="{{ asset('style_frontend/img/section-icon/section-icon-5.svg') }}"
                    alt="img_section-icon-5.svg">
            ...
            <div class="content-frequntly">
                <div class="image-frequntly">
                    <img src="{{ asset('style_frontend/img/about/about3.svg') }}" alt="img_about-3"
                        class="frequntly">
                </div>
...
<section style="background: #edf6fd;">
    <div class="container">
        <div class="content">
            <div class="header-content">
                <img src="{{ asset('style_frontend/img/section-icon/section-icon-2.svg') }}"
                    alt="img_section-icon-5.svg">
                ...
                <div class="row">
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="header-img">
                                <div class="testimonial-image">
                                    <img src="{{ asset('style_frontend/img/test-img/3.jpg') }}" alt=""
                                        class="img-lovly">
                                </div>
                            </div>
                            ...
                            <div class="testimonial-description">
                                <div class="testimonial_text">
                                    <p class="ptd">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis
                                        magni, quisquam, accusantium dolores atque, doloribus odit minus maiores sunt
                    ...
                    <div class="col-lg-6">
                        <div class="single-testimonial">
                            ...
                            <div class="header-img">
                                <div class="testimonial-image">
                                    <img src="{{ asset('style_frontend/img/test-img/2.jpg') }}" alt=""
                                        class="img-lovly">
                                </div>
                            </div>
                            <!-- Testimonial Feedback Text  -->
        ...
        <div class="container-footer">
            <div class="kolom robovision pt-4">
                ...
                <div class="text-header-robovision">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit ducimus voluptatibus neque illo id
