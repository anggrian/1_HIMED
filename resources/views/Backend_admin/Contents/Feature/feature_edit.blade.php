      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('fitur.update', $features->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('PUT')
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" name="main_title" id="main_title" required="required" class="form-control" value="{{$features->main_title}}">
                  </div>
                </div>
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <textarea class="form-control" rows="3"  name="main_description" id="main_description" required>{{strip_tags($features->main_description)}}</textarea>
                  </div>
                </div>
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="main_description">Gambar  <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 ">
