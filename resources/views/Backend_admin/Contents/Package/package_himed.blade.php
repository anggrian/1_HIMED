      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('paket')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" name="title_package" id="title_package" required="required" class="form-control">
                  </div>
                </div>
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <textarea class="form-control" rows="3"  name="description_package" id="description_package"></textarea>
                    <script>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('paket.edit',  $paket->id) }}" class="btn btn-link text-success p-0" style="font-size: 20px;"> <i class="fa fa-edit"></i></a> 

                      <form action="{{ route('paket.delete',  $paket->id) }}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
