                    ...
                    <form class="form-signin" method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            <input type="text" name="name" id="inputName" value="{{ old('name') }}"
                                class="form-control {{ $errors->has('name') }}" placeholder="User Name" required="" />
                            @if ($errors->has('name'))
                        ...
                        <div>
                            <input type="email" name="email" id="inputEmail" value="{{ old('email') }}"
                                class="form-control {{ $errors->has('email') }}" placeholder="Email Address"
                                required="" />
                            @if ($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                        ...
                        <div>
                            <input type="password" name="password" id="inputPassword" value="{{ old('password') }}"
                                class="form-control {{ $errors->has('password') }}" placeholder="Password"
                                required="" />
